...
function AboutUs() {
  return (
    <div className="about-container">
      <h1>Our History</h1>
      <p>
        Travista is owned and managed by Travista .In Pvt. Ltd., a leading brand
        in web designing services and e-commerce solutions. Travista .In Pvt.
        ...
        Commendable success rate of other portals managed by Travista is a live
        paradigm of our work excellence.
      </p>
      <h1>Our Mission</h1>
      <p>
        Our missin is to touch the horizon where our capabilities may
